...
#注意:给变量赋值时，“=” 前后都不要有空格
function patch_list_s905d_vmx_ultra_aosp()
{
    ROOT_DIR=~/workspace/s905d # 根目录，这里约定为 auto_build.sh 所在目录
    PROJECT_NAME=s905d-sdk0111-vmx   #项目名称，可自行修改，注意不能与其他项目名称相同
    PROJECT_LUNCH_NAME=braun  #sdk编译对应的lunch
...
add_lunch_combo patch_list_s905d_vmx_ultra_aosp # 这里约定 add_lunch_combo 的参数、上面的 function 都跟 SDK_PATCH_LIST 相同
